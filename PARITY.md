...
- No Config Platform app-config import contract includes app-team DRY ownership (`provider-config-*`) and platform-owned WET targets with inverse-edit hints for runtime provider fields
