...
var familySpecs = map[model.GeneratorKind]FamilySpec{
	...
	model.GeneratorOpenChoreo: {
		...
		InversePatchTemplates: map[string]InversePatchTemplate{
			"image":            {EditableBy: "app-team", Confidence: 0.88, RequiresReview: false},
			"env_var":          {EditableBy: "environment-owner", Confidence: 0.84, RequiresReview: false},
		...
		InversePointerTemplates: map[string]InversePointerTemplate{
			"image":            {Owner: "app-team", Confidence: 0.88},
			"env_var":          {Owner: "environment-owner", Confidence: 0.84},
		...
		RenderedLineageTemplates: []RenderedLineageTemplate{
			{Kind: "RenderedRelease", NameTemplate: "{{name}}-prod", Namespace: "apps", SourcePathHint: "rendered_release_path", SourceDryPathTemplate: "spec"},
			{Kind: "Deployment", NameTemplate: "{{name}}", Namespace: "apps", SourcePathHint: "workload_path", SourceDryPathTemplate: "spec.containers.main.image"},
		...
		InputRoleRules: []InputRoleRule{
			...
			{Role: "secret-reference", ExactBasenames: []string{"secret-reference.yaml", "secret-reference.yml"}},
			{Role: "rendered-release", Prefixes: []string{"rendered-release-"}, Extensions: []string{".yaml", ".yml"}},
			{Role: "rendered-release", ExactBasenames: []string{"rendered-release.yaml", "rendered-release.yml"}},
			{Role: "rendered-manifest", PathPrefixes: []string{"rendered/"}, Extensions: []string{".yaml", ".yml"}},
		},
	...
	model.GeneratorC3Agent: {
		...
		InversePatchTemplates: map[string]InversePatchTemplate{
			...
			"agent_runtime":   {EditableBy: "platform-engineer", Confidence: 0.88, RequiresReview: true},
			"storage":         {EditableBy: "platform-engineer", Confidence: 0.85, RequiresReview: true},
			"replicas":        {EditableBy: "app-team", Confidence: 0.89, RequiresReview: false},
			"rbac":            {EditableBy: "platform-engineer", Confidence: 0.82, RequiresReview: true},
		},
		InversePointerTemplates: map[string]InversePointerTemplate{
			...
			"agent_runtime":   {Owner: "platform-engineer", Confidence: 0.88},
			"storage":         {Owner: "platform-engineer", Confidence: 0.85},
			"replicas":        {Owner: "app-team", Confidence: 0.89},
			"rbac":            {Owner: "platform-engineer", Confidence: 0.82},
		},
		FieldOriginConfidences: map[string]float64{
			"fleet_config":            0.91,
			"credentials":             0.86,
		...
		RenderedLineageTemplates: []RenderedLineageTemplate{
			...
			{Kind: "Deployment", NameTemplate: "{{name}}-controlplane", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "components.controlplane.replicas"},
			{Kind: "Deployment", NameTemplate: "{{name}}-gateway", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "components.gateway.replicas"},
			{Kind: "Service", NameTemplate: "{{name}}-controlplane", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "components.controlplane.grpc_port"},
			{Kind: "Service", NameTemplate: "{{name}}-gateway", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "components.gateway.grpc_port"},
			{Kind: "ServiceAccount", NameTemplate: "{{name}}-agent", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "service"},
			{Kind: "ClusterRole", NameTemplate: "{{name}}-job-runner", SourcePathHint: "base_config_path", SourceDryPathTemplate: "service"},
			{Kind: "ClusterRoleBinding", NameTemplate: "{{name}}-job-runner", SourcePathHint: "base_config_path", SourceDryPathTemplate: "service"},
			{Kind: "PersistentVolumeClaim", NameTemplate: "{{name}}-taskdata", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "storage.task_pvc_size"},
			{Kind: "ConfigMap", NameTemplate: "{{name}}-job-template", Namespace: "apps", SourcePathHint: "base_config_path", SourceDryPathTemplate: "agent_runtime.image"},
		},
		...
		WetTargets: []WetTargetTemplate{
			...
			{Kind: "Deployment", NameTemplate: "{{name}}-controlplane", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "components.controlplane.replicas"},
			{Kind: "Deployment", NameTemplate: "{{name}}-gateway", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "components.gateway.replicas"},
			{Kind: "Service", NameTemplate: "{{name}}-controlplane", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "components.controlplane.grpc_port"},
			{Kind: "Service", NameTemplate: "{{name}}-gateway", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "components.gateway.grpc_port"},
			{Kind: "ServiceAccount", NameTemplate: "{{name}}-agent", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "service"},
			{Kind: "ClusterRole", NameTemplate: "{{name}}-job-runner", Owner: "platform-runtime", SourceDryPathTemplate: "service"},
			{Kind: "ClusterRoleBinding", NameTemplate: "{{name}}-job-runner", Owner: "platform-runtime", SourceDryPathTemplate: "service"},
			{Kind: "PersistentVolumeClaim", NameTemplate: "{{name}}-taskdata", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "storage.task_pvc_size"},
			{Kind: "ConfigMap", NameTemplate: "{{name}}-job-template", Owner: "platform-runtime", Namespace: "apps", SourceDryPathTemplate: "agent_runtime.image"},
		},
	},
