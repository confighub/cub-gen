.PHONY: build test test-parity test-contracts test-bridge-symmetry test-examples test-connected-lifecycles test-live-reconcile-flux test-live-reconcile-argo lint-dual-mode check-story-status update-goldens sync-triple-styles ci ci-local ci-connected docs docs-serve
...
ci-connected: build test-connected-lifecycles test-live-reconcile-flux test-live-reconcile-argo check-story-status
