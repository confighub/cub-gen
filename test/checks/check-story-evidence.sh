...
assert_jq "$story1" '.ingest_status != "ingested-fallback"' "story 1 no fallback ingest"
...
assert_jq "$story7" '.ingest_status != "ingested-fallback"' "story 7 no fallback ingest"
...
assert_jq "$story8" '.ingest_status != "ingested-fallback"' "story 8 no fallback ingest"
...
assert_jq "$story9" '[.targets[].ingest_status] | all(. != "ingested-fallback")' "story 9 no fallback ingest"
...
if [ -n "$story10" ]; then
  ...
  assert_jq "$story10" '.ingest_status != "ingested-fallback"' "story 10 no fallback ingest"
...
assert_jq "$story11_ingest" '.status != "ingested-fallback"' "story 11 no fallback ingest"
...
assert_jq "$story12" '.ingest_status != "ingested-fallback"' "story 12 no fallback ingest"
...
assert_jq "$connected_e2e" '.governed_change.ingest_status != "ingested-fallback"' "story 13 no fallback ingest"
