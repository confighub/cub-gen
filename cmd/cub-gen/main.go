	...
	printCommandHelp(
		...
		helpSection{
			...
			Lines: []string{
				...
				"  platform adapt    Plan placeholder replacement for a cloned Deployment Variant",
	...
	printCommandHelp(
		...
		helpSection{
			...
			Lines: []string{
				...
				"  cub-gen change impact --change-id ID --bundle FILE [--variant VARIANT] [--dry-path PATH] [--wet-path PATH] [--owner OWNER] [--out FILE|-] [--json] [--pretty]",
				...
				"  cub-gen change explain --change-id ID --bundle FILE [--variant VARIANT] [--wet-path PATH] [--dry-path PATH] [--owner OWNER] [--out FILE|-] [--json] [--pretty]",
		...
		helpSection{
			...
			Lines: []string{
				...
				"  cub-gen change explain --change-id chg_123 --bundle fanout.json --variant checkout-api/dev",
