...
func printGitOpsUsage(out io.Writer) {
	...
	fmt.Fprintln(out, "  kind = 'HelmRelease' | kind = 'Application' | kind = 'Kustomization' | kind = 'Component' | kind = 'ConfigMap'")
	fmt.Fprintln(out, "  kind IN ('HelmRelease','Application','Component','ConfigMap')")
