...
This document captures observations from running the [promotion-demo-data](https://github.com/confighub/examples/blob/86448c67b15dc145a3bafc3013bee6cf76ba1415/promotion-demo-data/README.md) example and how they validate the `cub-proc` design.
