...
- runnable scenarios and worked examples live in [`confighub/examples`](https://github.com/confighub/examples)
...
Examples from `confighub/examples`:
...
That is already visible in the runnable examples in `confighub/examples`.
...
- [../global-app-layer](https://github.com/confighub/examples/blob/86448c67b15dc145a3bafc3013bee6cf76ba1415/incubator/global-app-layer/README.md)
