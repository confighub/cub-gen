...
| Cloned deployment adaptation | [`deployment-adaptation`](../testdata/deployment-adaptation/) | clone -> add Target -> placeholders block apply -> review replacements | fixture-backed dry-run proof |
