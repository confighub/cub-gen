...
| Connected acceptance scope | For release-gate changes | `./test/checks/check-connected-release-gate.sh` | connected smoke lane still matches the claimed flagship proof lanes |
