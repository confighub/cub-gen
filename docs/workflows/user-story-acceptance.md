...
| 7 | (b) Brownfield Spring Boot/Helm users | (c) AI + developer collaborative workflows | CI-centric connected API flow | `examples/demo/story-7-ci-api-flow-connected.sh` | `.tmp/ci-connected/*/*/story-7-summary.json` |
