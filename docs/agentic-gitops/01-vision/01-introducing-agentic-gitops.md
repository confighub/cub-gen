...
|-----|------|
| The generator model and maturity levels | [02 — Generators PRD](../02-design/10-generators-prd.md) |
| Field-origin maps and the editing experience | [03 — Field-Origin Maps and Editing](../02-design/20-field-origin-maps-and-editing.md) |
| The ConfigHub data model | [04 — App Model and Contracts](../02-design/30-app-model-and-contracts.md) |
| cub-track, the mutation ledger | [05 — cub-track](../05-rollout/10-cub-track.md) |
| The governed execution architecture | [06 — Governed Execution](../02-design/40-governed-execution.md) |
| What it looks like to use | [07 — User Experience](../05-rollout/30-user-experience.md) |
| How to adopt and the business case | [08 — Adoption and Reference](../05-rollout/40-adoption-and-reference.md) |
