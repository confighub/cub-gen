...
Status: connected roadmap draft; OpenChoreo vertical slice implemented on this branch
Date: 2026-04-30
...
adapter, `gitops discover --adoption-report`, OpenChoreo field-route proof, and
golden parity coverage. It is not yet full upstream OpenChoreo conformance or a
multi-repo platform-estate importer.
...
- [ ] [#276](https://github.com/confighub/cub-gen/issues/276) Add generic platform import graph
- [x] [#290](https://github.com/confighub/cub-gen/issues/290) Produce an existing-platform adoption report before rewrites
- [ ] [#279](https://github.com/confighub/cub-gen/issues/279) Add one-command multi-env and tenant fanout
...
for an existing platform before proposing annotations or rewrites.
...
- [ ] [#278](https://github.com/confighub/cub-gen/issues/278) Add Argo app-of-apps generator boundary

Done means the roadmap has external, recognizable platform examples that teach
the same small model. For OpenChoreo specifically, done means we have real
fixture proof for existing CRD-shaped inputs, generated Kubernetes resources,
ownership boundaries, unresolved references, and apply-here/lift-upstream/
overlay/block-escalate routing.
...
- [ ] [#280](https://github.com/confighub/cub-gen/issues/280) Preview and write provenance enrichment artifacts
